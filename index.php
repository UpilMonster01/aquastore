...
<body>
    ...
    <section class="hero-home">
        <div class="hero-content">
            ...
            <div class="hero-benefits">
                <div>
                    <b>🐠</b>
                    <span>Ikan Sehat<br>Berkualitas</span>
                </div>
                <div>
                    <b>🛡️</b>
                ...
                <div>
                    <b>🚚</b>
                    <span>Pengiriman<br>Cepat Aman</span>
                </div>
            </div>
            <a href="pelanggan/katalog.php" class="hero-button">🐟 Lihat Katalog →</a>
            <div class="category-home">
                <a href="pelanggan/katalog.php?kategori_air=Tawar">🐟 Air Tawar</a>
                <a href="pelanggan/katalog.php?kategori_air=Laut">🌊 Air Laut</a>
                <a href="pelanggan/katalog.php?kategori_sifat=Predator">🦈 Predator</a>
                <a href="pelanggan/katalog.php?kategori_sifat=Non-Predator">🐠 Non-Predator</a>
            </div>
        </div>
        ...
        <div class="fish-grid">
            <?php foreach ($ikanPopuler as $i): ?>
                <div class="fish-card">
                    ...
                    <a href="pelanggan/detail.php?id=<?= $i['id'] ?>" class="mini-button">Detail</a>
                </div>
            <?php endforeach; ?>
        </div>
    </section>
    ...
    <footer class="footer">
        <h2>AquaStore</h2>
        <p>Modern Aquarium Store © <?= date('Y') ?></p>
        <button class="admin-secret" onclick="openLogin()">Admin</button>
    </footer>

    <div class="login-modal" id="loginModal">
        <form action="proses/login.php" method="POST" class="login-box">
            <button type="button" class="close-btn" onclick="closeLogin()">×</button>
            <h2>Login Admin</h2>
            <?php show_flash(); ?>
