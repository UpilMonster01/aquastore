                                ...
                                <?php if (!empty($buktiPembayaran)): ?>
                                    <div class="proof-current">
                                        <?php if (is_image_file($buktiPembayaran)): ?>
                                            <img src="../uploads/bukti/<?= e($buktiPembayaran) ?>" alt="Bukti pembayaran" class="proof-img">
                                        <?php else: ?>
                                            ...
                                            <div class="order-product-item">
                                                <div class="order-product-img">
                                                    <?php if (!empty($item['foto_ikan'])): ?>
                                                        <img src="../uploads/ikan/<?= e($item['foto_ikan']) ?>"
                                    ...
                                    <div class="order-product-list">
                                        <?php foreach ($detailPerlengkapan as $item): ?>
                                            <div class="order-product-item">
                                                ...
                                                <div class="order-product-info">
                                                    <h5><?= e($item['nama_perlengkapan'] ?: 'Produk perlengkapan tidak ditemukan') ?>
                                                    </h5>
