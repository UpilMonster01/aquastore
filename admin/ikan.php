                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php if(!empty($i['foto'])): ?>
                                ...
                                <img
                                    src="../uploads/ikan/<?= e($i['foto']) ?>?v=<?= time() ?>"
                                    class="thumb"
                                >
                        ...
                        <td>
                            ...
                            <button
                                class="mini-button"
                                onclick="openModal('edit<?= $i['id'] ?>')"
                            >
                                Edit
                            </button>

                            <form
                                action="../proses/hapus-ikan.php"
                                method="POST"
